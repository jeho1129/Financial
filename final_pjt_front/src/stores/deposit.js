...
export const useDepositStore = defineStore("deposit", () => {
  const optionList = [
    ...
    },
    {
      dcls_month: "202310",
      fin_co_no: "0010022",
      fin_prdt_cd: "10-01-20-024-0059-0000",
      intr_rate_type: "S",
      intr_rate_type_nm: "단리",
      save_trm: "12",
      intr_rate: 4.07,
  ...
  const baseList = [
    ...
    },
    {
      ...
      mtrt_int: "만기 후 1개월 미만 경과 : 약정이자율 x 50%\n만기 후 3개월 미만 경과 : 약정이자율 x 25% \n만기 후 3개월 이상 경과 : 약정이자율 x 10%",
      spcl_cnd:
        "최고우대금리 : 연0.45%p\n-지난달 DGB대구은행 통장으로 연금 입금 실적 보유 : 연0.10%p\n-상품 가입 전 DGB대구은행 신용(체크)카드 보유 : 연0.10%p\n-지난 3개월 예금 평잔 30만원 이상 : 연0.10%p\n-DGB행복파트너적금 동시 가입 및 만기 보유 : 연0.10%p\n*인터넷/스마트뱅킹을 통해 가입 : 연0.05%p",
      join_deny: "3",
    ...
    },
    {
      ...
      mtrt_int: "- 만기후1년내: 가입기간별 일반정기예금이율 x 50%,\n- 만기후1년초과:가입기간별 일반정기예금이율 x 20%",
      spcl_cnd:
        "* 우대이율(최대 0.40%p)\n가. 모바일뱅킹 금융정보 및 혜택알림 동의 우대이율 : 0.10%p\n나. 이벤트 우대이율 : 최대 0.30%p \n① 더(The) 특판 정기예금 신규고객 우대이율 : 0.30%p\n② 가입금액 1.5억원 이상 가입시 : 0.15%p\n※ 단,①과 ②의 우대이율은 중복 불가(중복 시, ①의 우대이율 적용)",
      join_deny: "1",
      join_member: "실명의 개인",
      etc_note: "1. 가입금액 : 1백만원 이상 제한없음 (원단위)\n2. 가입기간 : 1개월, 3개월, 6개월, 1년, 2년, 3년\n3. 이자지급방식 : 만기일시지급식",
      max_limit: null,
      dcls_strt_day: "20231020",
      dcls_end_day: null,
      fin_co_subm_day: "202310201007",
    },
    {
      ...
      fin_prdt_cd: "01030500600002",
      kor_co_nm: "부산은행",
      fin_prdt_nm: "더(The) 레벨업 정기예금",
      join_way: "스마트폰",
      mtrt_int: "- 만기후1년내: 가입기간별 일반정기예금이율 x 50%,\n- 만기후1년초과:가입기간별 일반정기예금이율 x 20%",
      spcl_cnd:
        "*우대이율(최대 0.40%p)\n가. 모바일뱅킹 금융정보 및 혜택알림 동의 우대이율 : 0.10%p\n나. 이벤트 우대이율 : 최대 0.30%p\n① 비대면 정기예금 재예치 우대이율  : 0.30%\n② 거래실적 우대이율  : 최대 0.30%p\n※ 단,①과 ②의 우대이율은 중복 불가",
      join_deny: "1",
      join_member: "제한없음",
      etc_note: "1. 가입금액 : 1백만원 이상 제한없음 (원단위)\n2. 가입기간 : 6개월, 1년\n3. 이자지급방식 : 만기일시지급식",
      max_limit: null,
    ...
    },
    {
      ...
      fin_prdt_cd: "TD11300031000",
      kor_co_nm: "광주은행",
      fin_prdt_nm: "스마트모아Dream정기예금",
      join_way: "인터넷,스마트폰",
      mtrt_int: "*만기후 1개월 이내: 만기일 당시 최초 가입 기간별 일반정기예금 고시금리의 1/2 \n*만기후 1개월 초과: 0.01%",
      spcl_cnd: "▶ 1천만원 이상 가입시 최대 0.2%우대",
      join_deny: "1",
      join_member: "개인 및 개인사업자",
      etc_note: "1. 가입기간 : 1개월이상 3년제\n2. 최소가입금액 : 100만원이상",
      max_limit: null,
      dcls_strt_day: "20231117",
      dcls_end_day: null,
      fin_co_subm_day: "202311170908",
    },
    {
      dcls_month: "202310",
      fin_co_no: "0010019",
      ...
      mtrt_int: "*만기후 1개월 이내: 만기일 당시 최초 가입 기간별 일반정기예금 고시금리의 1/2 \n*만기후 1개월 초과: 0.01%",
      spcl_cnd:
        "▶ 최고우대금리 0.5% \n ① 첫예금거래 : 0.4% -최근1년동안 정기예금 계좌 신규 또는 해지이력이 없는경우\n ② 개인(신용)정보 수집이용동의 : 0.1% -만기일전일까지 유지시\n▶ 이벤트금리 0.1% -이벤트 기간동안 가입 후 만기 해지시\n ※ 이벤트기간:23.10.19~23.12.29",
      join_deny: "1",
      join_member: "개인 및 개인사업자",
      etc_note: "1. 가입기간 : 1년제\n2. 가입금액 : 1백만원이상 최고 1억원(1인1계좌)",
      max_limit: 100000000,
      dcls_strt_day: "20231117",
      dcls_end_day: null,
      fin_co_subm_day: "202311170907",
    },
    {
      ...
      spcl_cnd: "해당사항 없음",
      join_deny: "1",
      join_member: "개인 및 법인(단,국가 지자체 및 금융기관 제외)",
      etc_note: "1. 가입기간 : 3개월,6개월,1년제\n2. 가입금액 : 10백만원이상 고객당 10억원한도",
      max_limit: 1000000000,
      dcls_strt_day: "20231113",
      dcls_end_day: null,
      fin_co_subm_day: "202311131115",
    },
    {
      dcls_month: "202310",
      fin_co_no: "0010020",
    ...
    },
    {
      ...
      fin_prdt_cd: "10-01-20-024-0059-0000",
      kor_co_nm: "전북은행",
      fin_prdt_nm: "JB 123 정기예금\n (만기일시지급식)",
      join_way: "인터넷,스마트폰",
      mtrt_int: "만기후 1개월 이하 : 만기일 현재 계약기간별 정기예금 실행이율 1/2\n만기후 1개월 초과 : 연 0.01%",
      spcl_cnd: "자동재예치 우대이율\n1회차 0.1%,\n2회차 0.2%,\n3회차 0.3%",
      join_deny: "1",
      join_member: "실명의 개인 또는 개인사업자 (1인 다계좌 가입 가능함)",
      etc_note:
        "예금의 신규 : 인터넷뱅킹, 모바일뱅킹, 모바일웹, BDT\n예금의 해지 : 인터넷뱅킹, 모바일뱅킹, 영업점\n가입금액 최저 1백만원이상 고객별 5억원 이사 (다만 자동재예치시 이자 원가로 인한 5억원 초과는 가능), 계좌수 관계없이 가입가능",
      max_limit: 500000000,
      dcls_strt_day: "20231113",
      dcls_end_day: null,
      fin_co_subm_day: "202311131258",
    ...
    },
    {
      ...
      join_deny: "1",
      join_member: "실명의 개인\n(개인사업자 제외)",
      etc_note: "계좌 수 제한 없으며, 최소 1백만원 이상 통합한도 1억원 이내 가입 가능",
      max_limit: 100000000,
      dcls_strt_day: "20231020",
      dcls_end_day: null,
      fin_co_subm_day: "202310200925",
    },
    {
      dcls_month: "202310",
      fin_co_no: "0010026",
      ...
      mtrt_int:
        "만기일 당시 정기예금 만기후 이자율 적용 -1개월 이내: 만기일 당시 계약기간별 고시금리×50% -1월 초과 6개월 이내: 만기일 당시 계약기간별 고시금리×30% -6개월 초과: 만기일 당시 계약기간별 고시금리×20%",
      spcl_cnd:
        "- i-ONE BANK(개인)을 통해 수행한 미션 스탬프 수에 따라 최고 연 0.30%p 우대\n1. 스탬프 2~4개 적립 : 연 0.1%p\n2. 스탬프 5~9개 적립 : 연 0.2%p\n3. 스탬프 10개 적립 : 연 0.3%p",
      join_deny: "1",
      join_member: "실명의 개인\n(개인사업자 제외)",
      etc_note: "계좌 수 제한 없으며, 최소 1백만원 이상\n통합한도 3천만원 이내 가입 가능",
      max_limit: 30000000,
      dcls_strt_day: "20231020",
      dcls_end_day: null,
      fin_co_subm_day: "202310200925",
    },
    {
      ...
      join_deny: "1",
      join_member: "실명의 개인\n(개인사업자 제외)",
      etc_note: "계좌 수 제한 없으며, 최소 1백만원 이상 납입한도 제한 없음",
      max_limit: null,
      dcls_strt_day: "20231117",
      dcls_end_day: null,
      fin_co_subm_day: "202311170931",
    },
    {
      dcls_month: "202310",
      fin_co_no: "0010030",
      ...
      etc_note: "해당없음",
      max_limit: null,
      dcls_strt_day: "20231024",
      dcls_end_day: null,
      fin_co_subm_day: "202310241004",
    },
    {
      dcls_month: "202310",
      fin_co_no: "0010030",
    ...
    },
    {
      ...
      spcl_cnd: "12개월 가입 시, 특별우대금리 0.1%p",
      join_deny: "1",
      join_member: "개인",
      etc_note: "1. 10만원 이상 10억원 이내 가입",
      max_limit: 1000000000,
      dcls_strt_day: "20231117",
      dcls_end_day: null,
      fin_co_subm_day: "202311170911",
    ...
    },
    {
      ...
      etc_note: "-1인 다계좌 가능.\n 단, 합산금액 최대 2억원 이내\n-최저 10만원 이상",
      max_limit: 200000000,
      dcls_strt_day: "20231030",
      dcls_end_day: null,
      fin_co_subm_day: "202310300916",
    },
    {
      dcls_month: "202310",
      fin_co_no: "0014807",
    ...
    },
    {
      ...
      max_limit: null,
      dcls_strt_day: "20231110",
      dcls_end_day: null,
      fin_co_subm_day: "202311101043",
    },
    {
      dcls_month: "202310",
      fin_co_no: "0017801",
      ...
      dcls_strt_day: "20231020",
      dcls_end_day: "99991231",
      fin_co_subm_day: "202310201104",
    },
  ];

  const popularDeposits = computed(() => {
    return baseList.toSorted((a, b) => b["fin_co_no"] - a["fin_co_no"]).splice(0, 4);
  });

  return { optionList, baseList, popularDeposits };
});
