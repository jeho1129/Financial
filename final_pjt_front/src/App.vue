            ...
            <ul v-else class="navbar-nav mb-lg-0">
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li data-bs-dismiss="offcanvas" aria-label="Close">
                    <RouterLink :to="{ name: 'recommendProduct' }" class="dropdown-item">상품 추천 받기 (선호도)</RouterLink>
                  </li>
                  <li data-bs-dismiss="offcanvas" aria-label="Close">
                    <RouterLink :to="{ name: 'recommendProductInfo' }" class="dropdown-item">상품 추천 받기 (유저 정보)</RouterLink>
                  </li>
                </ul>
              </li>
              <!-- <li class="nav-item" data-bs-dismiss="offcanvas" aria-label="Close">
