    ...
    <nav class="navbar navbar-expand-md bg-white mt-0 py-4">
      <div class="container-fluid">
        <RouterLink
          to="/"
          class="navbar-brand"
          style="font-family: 'Vina Sans', sans-serif"
          >Jiho Bank</RouterLink
        >
        <button
          ...
          <div class="offcanvas-body">
            <ul class="navbar-nav me-auto mb-lg-0">
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  <li data-bs-dismiss="offcanvas" aria-label="Close">
                    <RouterLink :to="{ name: 'deposit' }" class="dropdown-item"
                      >정기예금</RouterLink
                    >
                  </li>
                  <li data-bs-dismiss="offcanvas" aria-label="Close">
                    <RouterLink :to="{ name: 'saving' }" class="dropdown-item"
                      >정기적금</RouterLink
                    >
                  </li>
                </ul>
              ...
              <li
                ...
                aria-label="Close"
              >
                <RouterLink to="/bankMap" class="nav-link"
                  >은행 지도</RouterLink
                >
              </li>
              <li
            ...
            <ul v-if="!authStore.isAuthenticated" class="navbar-nav mb-lg-0">
              <li
                ...
                aria-label="Close"
              >
                <span @click="signUp" class="nav-link" style="cursor: pointer"
                  >회원가입</span
                >
              ...
              <li
                ...
                aria-label="Close"
              >
                <span @click="logIn" class="nav-link" style="cursor: pointer"
                  >로그인</span
                >
            ...
            <ul v-else class="navbar-nav mb-lg-0">
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li data-bs-dismiss="offcanvas" aria-label="Close">
                    <a class="dropdown-item" href="#">상품 추천 받기</a>
                  </li>
                </ul>
              </li>
              <!-- <li class="nav-item" data-bs-dismiss="offcanvas" aria-label="Close">
