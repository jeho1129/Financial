    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ManyToManyField(blank=True, null=True, related_name='deposits', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='SavingProducts',
            fields=[
                ...
                ('spcl_cnd', models.TextField()),
                ('join_deny', models.IntegerField()),
                ('user', models.ManyToManyField(blank=True, null=True, related_name='savings', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='SavingReviews',
